...
A basic javascript program for my 8th homework assignment
*/
...
//quick error check to see if it generated all seven tiles
    if(i === 7) {
        console.log("i = " + i);
        return true;
    }
...
//checks to see if a letter is still available, replaces it with the next valid letter if not
...
//turn string into array, edit string, and rebuild as a new word
...
//validate word by the scrabble rules NOT WORKING
function validateWord(str) {
    ...
    var tripwire = false;
    var lttrcnt = 0;
    var errorlog = ["0", "0", "0"]; //3 zeros, 3 possible check failures
    ...
    //is it found in dictionary?

}

//compare char to alphabet cuz jquery is trash
...
//compare word to dictionary NOT WORKING
